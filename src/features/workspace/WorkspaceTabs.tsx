...
/** Horizontal tab bar for workspace sections (Memory, Crons, Config). */
      ...
      {tabs.map((tab, i) => {
        ...
        return (
          <button
            ...
            className={`panel-label flex min-h-9 min-w-[calc(50%-0.375rem)] flex-1 items-center justify-center gap-1 rounded-md border border-border/60 bg-background/35 px-2.5 text-center transition-colors focus-visible:ring-2 focus-visible:ring-purple/50 focus-visible:ring-offset-0 sm:min-h-0 sm:min-w-0 sm:flex-none sm:justify-start sm:border-0 sm:bg-transparent sm:px-0 ${
              i > 0 ? 'sm:ml-3' : ''
            } ${
              isActive
