...
function getCspDirectives(): string {
  ...
  _cspDirectives = [
    ...
    "frame-src 'self' blob: http://127.0.0.1:* http://localhost:* https://s3.tradingview.com https://www.tradingview.com https://www.tradingview-widget.com https://s.tradingview.com",
